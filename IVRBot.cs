namespace EmergencyServicesBot
{
    ...
    public class IVRBot : IDisposable, ICallingBot
    {
        ...
        private const string WelcomeMessage = "Hello Say something";
        private const string MainMenuPromptMessage = " press 1.";
        private const string NoConsultantsMessage = "You can press the hash key when finished.";
